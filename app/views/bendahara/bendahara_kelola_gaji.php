              ...
              <table
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <a class="text-decoration-none" href="<?php echo URLROOT . '/bendahara/edit_gaji/' . $data->gaji_id ?>">
                        <div class="btn btn-primary btn-sm d-grid">Edit</div>
                      </a>
                      <a class="text-decoration-none" href="<?php echo URLROOT . '/bendahara/hapus_gaji/' . $data->gaji_id ?>">
